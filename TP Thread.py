...
List of IPs address :\n")
    ...
    if "-p" in argv:
        h1 = threading.Thread(target=ping_linux, args=[success_list, list_ip[:mid]], daemon=True)
        h2 = threading.Thread(target=ping_linux, args=[success_list, list_ip[mid:]], daemon=True)
        h1.start()
        h2.start()
        
    elif "-s" in argv:
        h1 = threading.Thread(target=socket_linux, args=[success_list, list_ip[:mid], min_port, max_port], daemon=True)
        h2 = threading.Thread(target=socket_linux, args=[success_list, list_ip[mid:], min_port, max_port], daemon=True)
        h1.start()
        h2.start()
